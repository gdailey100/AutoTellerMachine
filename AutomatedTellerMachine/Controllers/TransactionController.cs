...
namespace AutomatedTellerMachine.Controllers
{
    ...
    {
        public IApplicationDbContext db = new IApplicationDbContext();
        ...
        public ActionResult Transfer(TransferViewModel transfer)
        {
            ...
            // check for a vaild destination account
            ...
            {
                ModelState.AddModelError("DestinationCheckingAccountNumber", "Invaild destination account number");
            }

            // add debit/credit transactions and updates accouint balances
            if (ModelState.IsValid)
            {
